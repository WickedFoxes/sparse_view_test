...
def train(model, local_rank, batch_size, data_path):
    ...
    dataset = VimeoDataset('test', data_path)
    train_data = DataLoader(dataset, batch_size=batch_size, pin_memory=True, num_workers=8)
...
if __name__ == "__main__":    
    ...
    parser.add_argument('--data_path', type=str, help='data path of vimeo90k', default="/home/kcj/Downloads/vimeo_interp_test")
